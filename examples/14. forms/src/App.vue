            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        ...
                        <!-- thid equal to v-model, we can use @change if we want to use lazy method -->
                        <input
                                type="text"
                                id="email"
                                class="form-control"
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                    ...
                    <select
                            ...
                            <!-- :selected will be overriden by v-model, so we have to  -->
                        <option v-for="(priority, index) in priorities" v-bind:key="index" 
